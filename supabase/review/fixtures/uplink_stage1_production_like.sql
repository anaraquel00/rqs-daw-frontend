-- Isolated local/CI fixture matching the observed Production rqs_uplinks shape.
-- It contains no Production credentials and must never target a remote database.
do $roles$
begin
...
create table public.rqs_uplinks (
  ...
  source_instagram integer null default 0,
  source_tiktok integer null default 0,
  source_facebook integer null default 0,
  source_youtube integer null default 0,
  source_direct integer null default 0,
...
-- A representative legacy unowned redirect row must survive every phase.
insert into public.rqs_uplinks(
  id, user_id, custom_slug, target_url, platform
) values (
  '99999999-9999-4999-8999-999999999999',
  null,
  'legacy-unowned-fixture',
  'https://example.com/legacy',
  null
);

-- Tracking V3 sentinels use the accepted object names/signature. Stage 1
-- creation scripts must preserve their definitions and ACLs byte-for-byte.
