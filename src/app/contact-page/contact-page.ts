...
const CONTACT_COPY: Record<UiLanguage, ContactCopy> = {
  pt: {
    ...
    supportDesc: 'Problemas técnicos, conta, mastering, stems, setlist, Uplink ou comportamento inesperado do Studio.',
  ...
  en: {
    ...
    supportDesc: 'Technical issues, account questions, mastering, stems, setlists, Uplink or unexpected Studio behavior.',
  ...
  pl: {
    ...
    supportDesc: 'Problemy techniczne, konto, mastering, stemy, setlisty, Uplink lub nieoczekiwane działanie Studio.',
