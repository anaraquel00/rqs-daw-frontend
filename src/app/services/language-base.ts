...
FOOTER_CONTACT: "Fale Conosco",
  ...
  AUTH_CONTINUE_EMAIL: "Continuar com email",
  AUTH_EMAIL_ADDRESS: "Endereço de email",
  AUTH_SEND_LINK: "Enviar link de acesso",
  AUTH_SENDING: "ENVIANDO...",
  AUTH_CHECK_EMAIL_TITLE: "Verifique seu email",
  AUTH_CHECK_EMAIL_BODY: "Enviamos um link seguro para entrar no RQS Studio.",
  AUTH_REQUIRED_TITLE: "Autenticação necessária",
  AUTH_REQUIRED_BODY: "Crie uma conta gratuita ou entre para continuar.",
  AUTH_REQUIRED_SECONDARY: "Você recebe 3 masterizações completas gratuitas durante o Public Beta.",
  AUTH_GOOGLE: "Continuar com Google",
  AUTH_GITHUB: "Continuar com GitHub",
  AUTH_CANCEL: "Agora não",
  AUTH_EMAIL_EMPTY: "Informe seu endereço de email.",
  AUTH_EMAIL_INVALID: "Informe um endereço de email válido.",
  AUTH_EMAIL_SEND_ERROR: "Não foi possível enviar o link de acesso. Tente novamente.",
  AUTH_EMAIL_RATE_LIMIT: "Muitas tentativas em pouco tempo. Aguarde alguns minutos e tente novamente.",
  AUTH_LINK_INVALID: "Este link de acesso é inválido ou expirou. Solicite um novo link.",
  AUTH_SESSION_MISSING: "Não foi possível concluir a autenticação. Solicite um novo link de acesso.",
  AUTH_RESELECT_TRACK: "Autenticação concluída. Selecione novamente a faixa para continuar o Mastering.",
  AUTH_DISMISS: "Fechar",
};
...
export const EN_DICT: typeof PT_DICT = {
  ...
  AUTH_SEND_LINK: "Send sign-in link",
  AUTH_SENDING: "SENDING...",
  AUTH_CHECK_EMAIL_TITLE: "Check your email",
  AUTH_CHECK_EMAIL_BODY: "We sent you a secure sign-in link to access RQS Studio.",
  AUTH_REQUIRED_TITLE: "Sign in required",
  AUTH_REQUIRED_BODY: "Create a free account or sign in to continue.",
  AUTH_REQUIRED_SECONDARY: "Get 3 free full masters during the Public Beta.",
  AUTH_GOOGLE: "Continue with Google",
  AUTH_GITHUB: "Continue with GitHub",
  AUTH_CANCEL: "Not now",
  AUTH_EMAIL_EMPTY: "Enter your email address.",
  AUTH_EMAIL_INVALID: "Enter a valid email address.",
  AUTH_EMAIL_SEND_ERROR: "We could not send the sign-in link. Please try again.",
  AUTH_EMAIL_RATE_LIMIT: "Too many attempts in a short time. Wait a few minutes and try again.",
  AUTH_LINK_INVALID: "This sign-in link is invalid or has expired. Request a new link.",
  AUTH_SESSION_MISSING: "We could not complete sign-in. Request a new sign-in link.",
  AUTH_RESELECT_TRACK: "Sign-in complete. Select your track again to continue Mastering.",
  AUTH_DISMISS: "Close",
...
export const PL_DICT: typeof PT_DICT = {
  ...
  AUTH_CONTINUE_EMAIL: "Kontynuuj przez e-mail",
  AUTH_EMAIL_ADDRESS: "Adres e-mail",
  AUTH_SEND_LINK: "Wyślij link do logowania",
  AUTH_SENDING: "WYSYŁANIE...",
  AUTH_CHECK_EMAIL_TITLE: "Sprawdź swoją skrzynkę e-mail",
  AUTH_CHECK_EMAIL_BODY: "Wysłaliśmy bezpieczny link do logowania do RQS Studio.",
  AUTH_REQUIRED_TITLE: "Wymagane logowanie",
  AUTH_REQUIRED_BODY: "Utwórz bezpłatne konto lub zaloguj się, aby kontynuować.",
  AUTH_REQUIRED_SECONDARY: "Podczas publicznej wersji beta otrzymujesz 3 bezpłatne pełne masteringi.",
  AUTH_GOOGLE: "Kontynuuj przez Google",
  AUTH_GITHUB: "Kontynuuj przez GitHub",
  AUTH_CANCEL: "Nie teraz",
  AUTH_EMAIL_EMPTY: "Wpisz adres e-mail.",
  AUTH_EMAIL_INVALID: "Wpisz prawidłowy adres e-mail.",
  AUTH_EMAIL_SEND_ERROR: "Nie udało się wysłać linku do logowania. Spróbuj ponownie.",
  AUTH_EMAIL_RATE_LIMIT: "Zbyt wiele prób w krótkim czasie. Odczekaj kilka minut i spróbuj ponownie.",
  AUTH_LINK_INVALID: "Ten link do logowania jest nieprawidłowy lub wygasł. Poproś o nowy link.",
  AUTH_SESSION_MISSING: "Nie udało się zakończyć logowania. Poproś o nowy link.",
  AUTH_RESELECT_TRACK: "Logowanie zakończone. Wybierz ponownie utwór, aby kontynuować mastering.",
  AUTH_DISMISS: "Zamknij",
};
